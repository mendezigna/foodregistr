...
export class WeekService {
    ...
    constructor(private router: Router, private fireDAO: AngularFirestore, private storeService: Store, private utilsService: UtilsService, private dayService : DayService){}
